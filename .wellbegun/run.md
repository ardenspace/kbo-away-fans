...
- [>] phase 2 integration stopped after round 2 REJECT (drain-mode) — round 1: Step 2.2 pending-family choice cleared by unrelated team-clear snapshot, allowing older B to override latest A → fixed in `eb10743`; round 2: slow optimistic LG selection is overwritten to null by the B-setting profile snapshot, temporarily violating team-theme priority (owner Step 2.1; fix next, then round 3 final verifier); full Flutter before round 2: 980 pass, 1 skip; probes: 2 written (`cycle3_phase2_fresh_r1_probe_test.dart`, `cycle3_phase2_fresh_journey_probe_test.dart`), 0 committed and retained
- [ ] 3.1
- [ ] 3.2
- [ ] phase 3 integration
- [ ] 4.1
