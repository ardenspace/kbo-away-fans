...
/// 처리로 꺼내 여기서 잰다.
///
/// 그 뒤 게이트웨이에 `withSeams` 주입점이 생겨 `obtainAccessToken` 안쪽도
/// 재어지게 됐지만(`kakao_gateway_test.dart`), 이 파일은 그대로 둔다 — 그 길로
/// 순서를 재려면 로그인 호출 하나를 통째로 갈아 끼우고 SDK 의 어휘를 함께
/// 세워야 해서, 규칙만 보는 이 시험보다 재는 것이 흐려진다.
///
